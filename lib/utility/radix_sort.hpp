...
template <std::random_access_iterator I, std::sentinel_for<I> S, std::random_access_iterator Out, std::random_access_iterator Buf, class Proj = std::identity>
...
template<std::ranges::random_access_range R, std::random_access_iterator Out, std::random_access_iterator Buf, class Proj = std::identity>
